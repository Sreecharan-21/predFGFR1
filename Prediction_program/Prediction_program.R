...
norm_test1 = predict(process1, test1) #Train normalization
norm_test1
...
write.xlsx2(rf.imp1s,"output file path.xlsx")
...
# Writing data_frame to excel sheet
write.xlsx2(rfes1s,"output file path.xlsx")
